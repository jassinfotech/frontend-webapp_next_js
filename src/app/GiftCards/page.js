...
function page() {
    ...
    const AllComponent = () => <div>
        <Cards />
        <div className='row'>
            <div className='col-lg-6'>
                <div className='py-3 cardheding'>Fashion & Lifestyle Gift Cards</div>
            </div>
            <div className='col-lg-6'>
                <div className='py-3 text-end'><Link className='viewmore' href="/Viewcards"> View More</Link></div>
            </div>
        </div>
        <Cards />
        <div className='row'>
            <div className='col-lg-6'>
                <div className='py-3 cardheding'>Brand Gift Cards</div>
            </div>
            <div className='col-lg-6'>
                <div className='py-3 text-end'><Link className='viewmore' href="/Viewcards"> View More</Link></div>
            </div>
        ...
        <div className='card_bg_img py-5 my-5'>
            <div className=''><b>Sell Your Gift Card</b></div>
            <p className=''>Have a Gift Card which you don't want to use? Why not sell it for hard cash.You can sell<br />
                variety of Gift Cards on crafin in just few simple steps & will get the money on bank account</p>
            <button className='big_card_btn' type='' >Sell Now</button>
        </div>
        <Cards />
    </div>;
