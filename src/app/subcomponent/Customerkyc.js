...
import { postApi, getApi } from '../helper/apiHelper';
const Customerkyc = ({handleNextStep}) => {
    ...
    const fetchData = async () => {
        try {
         ...
         const  kycStatus = data.data.kycData
    ...
    return (
        <>
            {activeStep === 0 ? <div>
                <div className='row pt-3'>
                        ...
                        <div class="stepper d-flex flex-column ml-2">
                            <div class="d-flex mb-1">
                                <div class="d-flex flex-column pr-4 align-items-center">
                                    <div class={`rounded-circle_f mb-1 border ${kycstatus.adhaar_kyc_status === 'verified' ? 'active bg-theme text-white' : ''}`}>{kycstatus.adhaar_kyc_status === 'verified' ? <><FaCheck /></> : <></>} </div>
                                    <div class="line h-100" style={{ backgroundColor: kycstatus.adhaar_kyc_status === 'verified' ? "#1587A0" :''}}></div>
                                </div>
                                    ...
                                    <div class="card text-dark mb-3 bg-transparent" style={{ borderColor: "#DCD9D9", borderRadius: "5px" }} >
                                        <div class="card-header bg-transparent">
                                            <div className='d-flex justify-content-between'>
                                               ...
                                               {kycstatus.adhaar_kyc_status === 'verified' ? <a href='' className='verified'>Verified</a> :<><button className='v_btn' onClick={() => handleStepClick(1)}> Verify </button></>} 
                                            </div>
                                        </div>
                            ...
                            <div class="d-flex mb-1">
                                <div class="d-flex flex-column pr-4 align-items-center">
                                    <div class={`rounded-circle_f mb-1 border ${kycstatus.pan_kyc_status === 'verified' ? 'active bg-theme text-white' : ''}`}>{kycstatus.pan_kyc_status === 'verified' ? <><FaCheck /></> : <></>} </div>
                                    <div class="line h-100" style={{ backgroundColor: kycstatus.pan_kyc_status === 'verified' ? "#1587A0" :''}}></div>
                                </div>
                                <div className='m-3 mt-0' style={{ width: "490px" }}>
                                    <div class="card text-dark mb-3 bg-transparent" style={{ borderColor: "#DCD9D9", borderRadius: "5px" }} >
                                        <div class="card-header bg-transparent">
                                            <div className='d-flex justify-content-between'>
                                                ...
                                                {kycstatus.pan_kyc_status === 'verified' ? <a href='' className='verified'>Verified</a> : <button className='v_btn' onClick={() => handleStepClick(2)}> Verify </button>}
                                            </div>
                                        </div>
                                        <div class="card-body bg-transparent py-4">
                    ...
                    <div className='col-md-12 text-end'>
                        <div className="my-3">
                            <button type="submit" className="btn but_skip" onClick={openModal}>
                                Skip
                            </button>
                        </div>
                    </div>
                            ...
                            <div className='col-md-12 col-lg-12 mt-4'>
                                <div className='row'>
                                    <div className='col-md-8 mx-auto d-flex justify-content-center'>
                                        ...
                                        <button className='btn btn_ok ms-2' onClick={handleSkipfun}>Ok</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            {activeStep === 1 ? <>
                <Aadharkyc handleNextStep={handleNextStep} />
            ...
            {activeStep === 2 ? <>
                <Pancardkyc handleNextStep={handleNextStep} />
            </> : <>
